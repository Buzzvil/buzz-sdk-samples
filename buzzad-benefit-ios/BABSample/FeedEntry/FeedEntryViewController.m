...
//
//static NSString * const kNavigationItemTitle = @"Custom Entry Points";
...
//- (void)preloadFeed;
//
//- (void)updateFeedEntryIconWithMessageTextWithReward:(double)reward;
//
//- (void)updateFeedEntryButtonTextWithReward:(double)reward;
//
//- (NSString *)stringFromReward:(double)reward;
//
//@end
//
...
//}
//
//- (void)setFeedConfig:(BABFeedConfig *)feedConfig {
...
//  _feedEntryIcon.clickableViews = @[_feedEntryIcon.iconImageView];
//  [_feedEntryIcon setFeedConfig:_feedConfig];
...
//  _feedEntryIconWithMessage.clickableViews = @[_feedEntryIconWithMessage.iconBackgoundView, _feedEntryIconWithMessage.iconImageView, _feedEntryIconWithMessage.messageLabel];
//  [_feedEntryIconWithMessage setFeedConfig:_feedConfig];
...
//  _feedEntryBanner.clickableViews = @[_feedEntryBanner.bannerImageView];
//  [_feedEntryBanner setFeedConfig:_feedConfig];
...
//  _feedEntryButton.clickableViews = @[_feedEntryButton.button];
//  [_feedEntryButton setFeedConfig:_feedConfig];
...
//
//- (void)preloadFeed {
//  [_feedEntryIconWithMessage.feedHandler preloadWithOnSuccess:^{
//    // Available rewards can be inaccurate after
//    //  1. ads are rewarded
//    //  2. new ads are loaded by scrolling feed
//    [self updateFeedEntryIconWithMessageTextWithReward:self->_feedEntryIconWithMessage.feedHandler.availableReward];
//  } onFailure:^(BABError * _Nonnull error) {
//  }];
//  
//  [_feedEntryButton.feedHandler preloadWithOnSuccess:^{
//    // Available rewards can be inaccurate after
//    //  1. ads are rewarded
//    //  2. new ads are loaded by scrolling feed
//    [self updateFeedEntryButtonTextWithReward:self->_feedEntryButton.feedHandler.availableReward];
//  } onFailure:^(BABError * _Nonnull error) {
//  }];
//}
//
...
//  return [numberFormatter stringFromNumber:[NSNumber numberWithDouble:reward]];
//}
//
//@end
