...
- (void)setupLayout {
  ...
  [NSLayoutConstraint activateConstraints:@[
    [_discountRateLabel.leadingAnchor constraintEqualToAnchor:_nativeAdView.leadingAnchor constant:8],
    [_discountRateLabel.topAnchor constraintEqualToAnchor:_descriptionLabel.bottomAnchor constant:8],
  ]];
  
  _priceLabel.translatesAutoresizingMaskIntoConstraints = NO;
  [NSLayoutConstraint activateConstraints:@[
    [_priceLabel.leadingAnchor constraintEqualToAnchor:_discountRateLabel.leadingAnchor constant:8],
    [_priceLabel.topAnchor constraintEqualToAnchor:_discountRateLabel.bottomAnchor constant:8],
  ]];
  
  _originalPriceLabel.translatesAutoresizingMaskIntoConstraints = NO;
  [NSLayoutConstraint activateConstraints:@[
    [_originalPriceLabel.leadingAnchor constraintEqualToAnchor:_nativeAdView.leadingAnchor constant:8],
    [_originalPriceLabel.topAnchor constraintEqualToAnchor:_discountRateLabel.bottomAnchor constant:8],
    [_originalPriceLabel.bottomAnchor constraintEqualToAnchor:_nativeAdView.bottomAnchor constant:8],
  ]];
