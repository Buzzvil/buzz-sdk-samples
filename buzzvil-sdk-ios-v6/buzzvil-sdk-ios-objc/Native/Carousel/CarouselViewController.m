...
- (void)setupCarousel {
  ...
  [self.nativeGroup loadWithCount:_adRequestCount onSuccess:^(NSInteger adCount) {
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
  ...
  BuzzNative * native = _nativeGroup.natives[indexPath.item];
...
//  BuzzNative * native = _nativeGroup.natives[indexPath.item % self.loadedAdCount];
//  
//  [cell bind:native];
//  return cell;
//}
