...
- L앱의 샘플을 활용하여 손쉽게 L앱을 만들 수 있습니다.([샘플을 활용하여 L앱 만들기](LIGHT-MIGRATION-L.md#샘플을-활용하여-L앱-만들기))
- 마이그레이션 SDK 이외에도 통신 모듈을 사용하여 [M앱과 L앱 간의 추가적인 통신](LIGHT-MIGRATION-L.md#M앱과-L앱-간의-통신-유틸)을 구현할 수 있습니다.
