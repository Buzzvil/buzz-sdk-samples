...
* [new] 더 높은 단가의 리워드 지급형 뉴스 콘텐츠(Rewarded Contents) 탑재
  * 기존보다 10% 더 높은 단가의 리워드 지급형 뉴스 콘텐츠를 송출하여 더 높은 수익은 물론, 더 많은 수익화 콘텐츠를 확보하게 되었습니다. 새로운 뉴스 콘텐츠는 유저의 페이지 체류 시간과 페이지 스크롤 높이를 감지하여 리워드를 지급하며, 외부 브라우저 및 인앱 브라우저 모두 지원합니다.
...
* [UPDATE] 다크모드 CTA 색상 개선
  * 다크모드에서 CTA 버튼을 강조할 수 있는 색상으로 개선했습니다.
