...
SWIFT_CLASS("_TtC16BuzzAdBenefitSDK20BABDeepLinkNavigator")
@interface BABDeepLinkNavigator : NSObject
- (void)navigateWithDeepLink:(BABDeepLink * _Nonnull)deepLink;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

@protocol BABBIEventTracker;

SWIFT_CLASS("_TtC16BuzzAdBenefitSDK18BABDeepLinkTracker")
@interface BABDeepLinkTracker : NSObject
- (nonnull instancetype)initWithEventTracker:(id <BABBIEventTracker> _Nonnull)eventTracker OBJC_DESIGNATED_INITIALIZER;
- (void)trackWithDeepLink:(BABDeepLink * _Nonnull)deepLink;
