...
#ifndef BUZZADBENEFITINTERSTITIAL_SWIFT_H
#define BUZZADBENEFITINTERSTITIAL_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="BuzzAdBenefitInterstitial",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC25BuzzAdBenefitInterstitial21BZVBuzzAdInterstitial")
...
@interface BZVBuzzAdInterstitial (SWIFT_EXTENSION(BuzzAdBenefitInterstitial))
...
SWIFT_CLASS("_TtC25BuzzAdBenefitInterstitial28BZVBuzzAdInterstitialBuilder")
...
SWIFT_PROTOCOL("_TtP25BuzzAdBenefitInterstitial29BZVBuzzAdInterstitialDelegate_")
