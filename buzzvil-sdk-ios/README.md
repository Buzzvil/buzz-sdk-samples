...
## [5.19.0] - 2024-08-22
* [NEW] 네이티브에서 베네핏허브로 이동하는 진입점 기능 추가
* [NEW] 베네핏허브 진입 시 지정된 필터나 럭키박스 페이지로 이동시키는 기능 추가
* [NEW] 럭키박스 수익화 장치 On/Off 기능 추가
* [UPDATE] 피드 내 스크롤 유도 버튼과 상단 이동 버튼의 가시성 수정
* [FIX] 베네핏허브에서 Dynamic 배너가 다른 페이지 방문 후 재노출되지 않는 문제 해결
* 자세한 사항은 [릴리스 뉴스](https://docs.buzzvil.com/docs/release-news/ios/buzzvil5.19) 참조
> ### [5.19.1] - 2024-08-22
...
* 자세한 사항은 [링크](https://docs.buzzvil.com/docs/release-news/ios/buzzvil5.13) 참조
> ### [5.13.1] - 2024-05-30
> * [FIX] event 수집 관련 버그 수정
...
> * [FIX] iOS 12 crash 수정
> ### [5.11.5] - 2024-05-17
> * [FIX] iOS 13.3 crash 수정
> ### [5.11.7] - 2024-08-29
> * [FIX] RemoteConfig 동시성 문제 해결
...
> * [FIX] Feed CTAButton reward icon empty UIImage를 넣을 경우 좌우 여백이 동일하도록 수정
> ### [5.9.8] - 2024-05-10
> * [UPDATE] 피드와 브릿지 페이지에 배너 반영
> * [UPDATE] AvatyeAdCash 2.1.7 라이브러리 반영
> ### [5.9.9] - 2024-05-14
> * [UPDATE] 임시적으로 피드와 브릿지 페이지의 배너 제거
